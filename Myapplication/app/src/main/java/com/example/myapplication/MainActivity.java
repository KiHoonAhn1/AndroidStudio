...
//        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("tel:010-8555-5432"));
//        startActivity(intent);
//    }
    public void clickBts(View view){
        ...
        if(view.getId() == R.id.button2){
            ...
            intent = new Intent(Intent.ACTION_VIEW, Uri.parse("tel:010-8555-5432"));
        }else if(view.getId() == R.id.button4){
            intent = new Intent(Intent.ACTION_CALL, Uri.parse("tel:010-8555-5432"));
