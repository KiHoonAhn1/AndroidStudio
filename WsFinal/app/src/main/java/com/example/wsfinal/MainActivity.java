...
//        Toast.makeText(this, id+pwd+quiz, Toast.LENGTH_SHORT).show();
        String url = "http://192.168.0.19/android/wsLogin.jsp";
...
//        thread 안에서 네트워크로 보내야 한다. 이러면 반응X
    ...
    class HttpAsync extends AsyncTask<String,String,String> {
        ...
        protected void onPreExecute() {
            progressDialog = new ProgressDialog(com.example.wsfinal.MainActivity.this);
...
//            Toast.makeText(MainActivity.this, s, Toast.LENGTH_LONG).show();
            if(s.equals("1")){
                Intent intent = new Intent(com.example.wsfinal.MainActivity.this, SecondActivity.class); // 이 부분 Second로 바꿔야 함
                startActivity(intent);
            }else if(s.equals("2")){
                AlertDialog.Builder dialog = new AlertDialog.Builder(com.example.wsfinal.MainActivity.this);
